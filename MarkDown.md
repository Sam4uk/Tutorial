Даний документ призначено для ознайомлення користувача з можливостями мови розмітки MarkDown.
Markdown – це полегшена мова розмітки, яка є проміжною перед перетворенням в мову гіпертекстової розмітки(тобто текст згодом перетворюється в HTML).
Головною особливістю цієї мови є максимально промтий синтаксис, який слугує для спрощення написання та читання розмітки, що дозволяє легко корегувати його.
Розглянемо більш детально можливості даної мови.
Markdown не є альтернативою HTML. Синтаксис Markdown сильно обмежений та відповідає невеликій кількості елемнтів HTML. Він включає в себе наступні елемнти:

1. Блокові елемнти
 + [Парагафи та розриви рядків](#Parag);
 + [Заголовки](#Headers);
 + [Цитати](#Blockquotes);
 + [Списки](#Lists)
 + [Блоки коду](#CodeBlocks);
 + [Горизонтальні (разділювальні) лінії](#Lines).
2. Рядкові елемнти
 + [Лінки](#Links);
 + [Виділення тексту](#Emphasis);
 + [Кодові фрагменти рядків](#Code);
 + [Зображення](#Images).
3. Додаткові елемети
 + [Зворотній слеш](#Backslash Escapes);
 + [Автоматичні лінки](#Automatic Links);
 + [Спеціальні символи HTML](#SpecialSymbol).  
